...
export const setup = (config) => {
    ...
    const { canvasElement, timerElement, p1HealthElement, p2HealthElement, centerTextElement, } = Utils.getHtmlElements();
    ...
    const player1GamepadListener = new GamepadListener({
        gamepadIndex: (_b = (_a = gamepads[0]) === null || _a === void 0 ? void 0 : _a.index) !== null && _b !== void 0 ? _b : null,
        config: config.commands.gamepad[(_c = gamepads[0]) === null || _c === void 0 ? void 0 : _c.id] ||
            config.commands.gamepad.default,
    });
    const player2GamepadListener = new GamepadListener({
        gamepadIndex: (_e = (_d = gamepads[1]) === null || _d === void 0 ? void 0 : _d.index) !== null && _e !== void 0 ? _e : null,
        config: config.commands.gamepad[(_f = gamepads[0]) === null || _f === void 0 ? void 0 : _f.id] ||
            config.commands.gamepad.default,
    });
    ...
    window.addEventListener('gamepadconnected', e => {
        if (!player1GamepadListener.gamepadIndex) {
            player1GamepadListener.setGamepad({
                ...
                config: config.commands.gamepad[e.gamepad.id] ||
                    config.commands.gamepad.default,
            });
            ...
            console.info('Gamepad Connected [not attached] (both players already have a connected gamepad)');
        }
    });
